...
class __TwigTemplate_55af162a50aa77e08b6ffb00b54d18d8485261918f6bf2e8536c0205bd139e8e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t            ";
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 106, $this->source); })()), "reciboDatos", [], "any", false, false, false, 106))) {
            ...
            // line 108
            echo "    \t            ";
            $context["subtotal"] = (twig_get_attribute($this->env, $this->source, (isset($context["detalleMonto"]) || array_key_exists("detalleMonto", $context) ? $context["detalleMonto"] : (function () { throw new RuntimeError('Variable "detalleMonto" does not exist.', 108, $this->source); })()), "MONTO_TOTAL", [], "any", false, false, false, 108) / 1.18);
            // line 109
            echo "                    <tr>
...
";
    ...
    {
        return new Source("", "/administration/reporte/recibo.twig", "C:\\xampp\\htdocs\\jass\\resources\\views\\administration\\reporte\\recibo.twig");
    }
}
