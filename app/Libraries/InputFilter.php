...
/** 
  ...
  * 
  *
  * Esta libreria fue actualizada para PHP7
  * Cambios:
  * Se cambio la función 'eregi' por 'preg_match' (en el método 'filterAttr')
  * nombre de la función 'inputFilter' por '__construct'
  */
class InputFilter {
	private $tagsArray;			// default = empty array
	private $attrArray;			// default = empty array

	private $tagsMethod;		// default = 0
	private $attrMethod;		// default = 0

	private $xssAuto;           // default = 1
	...
	private $attrBlacklist = array('action', 'background', 'codebase', 'dynsrc', 'lowsrc');  // also will strip ALL event handlers
